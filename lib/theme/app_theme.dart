...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xFF00c717),
      onTertiary: Color(0xFFFFFFFF),
      tertiaryContainer: Color(0xFF50ff67),
      onTertiaryContainer: Color(0xFF009f00),
      ...
      onPrimaryFixed: Color(0xFFbebebe),
      primaryFixedDim: Color(0xFFffffff),
      onPrimaryFixedVariant: Color(0xFFe6e6e6),
      secondaryFixed: Color(0xFF505050),
      onSecondaryFixed: Color(0xFF000000),
      secondaryFixedDim: Color(0xFF3c3c3c),
      onSecondaryFixedVariant: Color(0xFF000000),
      tertiaryFixed: Color(0xFF50ff67),
      onTertiaryFixed: Color(0xFF008b00),
      tertiaryFixedDim: Color(0xFF3cff53),
      onTertiaryFixedVariant: Color(0xFF00b303),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      onPrimary: Color(0xFF000000),
      primaryContainer: Color(0xFFbebebe),
      onPrimaryContainer: Color(0xFF000000),
      secondary: Color(0xFF000000),
      onSecondary: Color(0xFFFFFFFF),
      secondaryContainer: Color(0xFF000000),
      onSecondaryContainer: Color(0xFFFFFFFF),
      tertiary: Color(0xFF00b303),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFF008b00),
  ...
  static final AppBarTheme _lightAppBarTheme = AppBarTheme(
    ...
    backgroundColor: Color(0xFF00c717),
